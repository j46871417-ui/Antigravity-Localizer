...
if exist AntigravityLocalizer.exe copy /y AntigravityLocalizer.exe AntigravityLocalizer_v0.9.0.exe

if exist payload.zip del payload.zip
echo.
echo [✓] Готово! Создан чистый автономный AntigravityLocalizer.exe и AntigravityLocalizer_v0.9.0.exe
