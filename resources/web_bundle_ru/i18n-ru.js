...
(function () {
  ...
  const DICT = {
    ...
    "Agent stopped": "Агент остановлен",
    "Agent terminated due to error": "Агент прекращен из-за ошибки",
    ...
    "Also includes": "Также включает в себя",
    ...
    "This will archive": "Это будет заархивировано",
    ...
    "You can prompt the model to try again or start a new conversation if the error persists.": "Вы можете предложить модели повторить попытку или начать новый разговор, если ошибка не исчезнет.",
